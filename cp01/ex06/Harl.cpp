...
void    Harl::complain(std::string level_name)
{
    ...
    {
    case 0:
        std::cout << "[" << this->level[0].level_name << "]" << std::endl;
        (this->*level[0].func)();
        /* FALLTHROUGH */
    case 1:
        std::cout << "[" << this->level[1].level_name << "]" << std::endl;
        (this->*level[1].func)();
        /* FALLTHROUGH */
    case 2:
        std::cout << "[" << this->level[2].level_name << "]" << std::endl;
        (this->*level[2].func)();
        /* FALLTHROUGH */
    case 3:
        std::cout << "[" << this->level[3].level_name << "]" << std::endl;
        (this->*level[3].func)();
        break ;
    default:
